...
from yaml_util import create_root_molos_yaml, create_root_pubspec_yaml
...
def main():
    ...
    create_flutter_templates(monorepo_path, ["hello", "dirty_fellow"], True)
    create_flutter_templates(monorepo_path, ["hello", "dirty_fellow"], False)
